...
class CornerpointGrid:
    ...
    def find_cell_containing_point_column_interval_tree(
        self,
        points: npt.ArrayLike,
        map_coordinates: bool = True,
        tolerance: float = 1.0e-6,
        ...
        Uses a 1D interval tree over column bounding boxes to narrow
        down candidate columns before testing cells along z.
